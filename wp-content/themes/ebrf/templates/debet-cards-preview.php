<div class="company">
	...
	<div class="company__text">
		...
		<table class="company__table">
			...
			<tbody>
				<tr>
                    <td><?php echo get_field('company_percent_in_rest', get_the_ID()) . '%'; ?></td>
					<td><?php echo get_field('company_cash_back', get_the_ID()) . '%'; ?></td>
					<td><?php echo get_field('company_bonuces', get_the_ID()); ?></td>
