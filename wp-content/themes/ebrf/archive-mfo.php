		...
		<div class="catalog aside-wrapper">
			...
			<?php if ( have_posts() ) : ?>
				...
				<div class="catalog__content">
					<h1 class="archive-title"><?php if ($arch_title = get_field('mfo_down_title', 6)) echo $arch_title; else post_type_archive_title(); ?></h1>
					...
					<div class="catalog__content">
						<div class="term-head">
							...
							<div class="term-head-content">
								<h1 class="archive-title"><?php if ($term_title = get_field('mfo_term_title', $taxonomy . '_' . $term_id)) echo $term_title; else single_cat_title(); ?></h1>
