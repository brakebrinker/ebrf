			...
			<?php if ( have_posts() ) : ?>
				...
				<div class="catalog__content">
					...
					<?php while( have_posts() ){ 
						the_post();
						get_template_part( 'templates/debet-cards', 'preview' );
					}
				...
				<div class="catalog__content">
					<div class="term-head">
						<?php 
							$image = get_field('debet-cards_tax_text_icon', $taxonomy . '_' . $term_id);
							if( !empty($image) ): 
					...
					?>
					<?php get_template_part( 'templates/union', 'order' ); ?>
					<?php echo get_field('debet-cards_tax_text_down', $taxonomy . '_' . $term_id); ?>
				</div>
				<?php endif; ?>
			<?php else: ?>
				<div class="catalog__content">
					<h1 class="archive-title">Дебетовые карты не найдены.</h1>
				</div>
			<?php endif; ?>
		</div>
	</div>
